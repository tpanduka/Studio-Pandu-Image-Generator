    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 backdrop-blur-sm">
      <div className="bg-gray-800 border border-gray-700 p-8 rounded-xl shadow-2xl max-w-md w-full text-center">
        ...
        <p className="text-gray-300 mb-6">
          To generate high-quality 4K consistent characters, Studio Pandu requires a valid API key from Google AI Studio.
        </p>
        <div className="bg-gray-900 p-4 rounded mb-6 text-sm text-left border border-gray-700">
            <p className="text-yellow-400 font-semibold mb-1">Billing Info:</p>
            <p className="text-gray-400">
                Please ensure you have a project with billing enabled.
                <a 
